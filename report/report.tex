...
\begin{table}[H]		
	...
	\caption{Comparison between default and custom stopping cirterion.}		
...
For preserving population diversity we adapted a few of the functions in the template to work with subpopulations, simulating the island model. The results displayed in Table~\ref{tab:diversity1} through Table~\ref{tab:diversity20} show tests performed with 1, 2, 5, 10 and 20 subpopulations or islands.
...
\lstinputlisting[language=matlab]{"../src/run_ga.m"}
\end{document}
