...
\begin{table}[H]
	...
	\makebox[\textwidth]{
		\begin{tabular}{l rrrr}
			\toprule
			& \multicolumn{4}{c}{\# subpopulations = 20} \\
			\cmidrule{2-5}
			Dataset & \# Generations & Min & Mean & Max \\
			\midrule
